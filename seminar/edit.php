...
{   
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE seminartbl SET nip='$nip',nama='$nama',unit='$unit', seminar='$seminar',tahun='$tahun',jumlah='$jumlah' WHERE id=$id");
...
$query = mysqli_query($conn, "SELECT * FROM seminartbl WHERE id=$id");
...
<div class="container">
        <form id="contact" action="edit.php" method="post">
            ...
            <fieldset>
                <input placeholder="Seminar yang Diikuti" name="seminar" value=<?php echo $seminar;?> type="text" required>
            </fieldset>
            <fieldset>
